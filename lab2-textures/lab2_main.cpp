...
GLuint positionBuffer2, colorBuffer2, indexBuffer2, texcoordBuffer2, vertexArrayObject2;
...
void initialize()
{
	...
	//glBufferData(GL_ELEMENT_ARRAY_BUFFER, labhelper::array_length(indices) * sizeof(float), indices, GL_STATIC_DRAW);
