...
mat4 carModelMatrix = translate(vec3(0.0f, 5.0f, 0.0f));
mat4 carModelMatrix2 = translate(vec3(0.0f, 0.0f, 0.0f));
...
void display()
{
	...
	// car2
	mat4 rotate = glm::rotate(float(currentTime * M_PI * -0.5f), vec3(0.0f, 1.0f, 0.0f));
	mat4 translate = glm::translate(vec3(20.0f, 0.0f, 0.0f));
	mat4 translate2 = glm::translate(vec3(rotate * vec4(10.0f, 0, 0, 1.0f)));
	mat4 carModelMatrix2 = translate * translate2 * rotate;
...
bool handleEvents(void)
{
	...
	{
		cameraPosition -= 0.08f * cameraDirection;
	}
